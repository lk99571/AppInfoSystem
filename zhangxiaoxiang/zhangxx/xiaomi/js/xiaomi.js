/**
 * Created by Zhangdaixang on 2018/2/24.
 */
...
$("#find_but").hover(function () {
    ...
    $(this).css({"background": "#ff6700", color: "#424242"});
})
//------------------------------------------------------------------菜单栏的显示-------------------------
$("#banner_menu_wrap").children().hover(function () {
    $(this).css("background", "rgba(255,248,245,0.1)");//轮播图li的背景色
...
$(function () {
    ...
    var allimg = $("#big_banner_pic li").length;//获取图片长度
    /*轮播函数*/
    function img_change() {
        var img_i = i * -1226 + "px";//声明变量
...
$(".floor_goods_wrap_li").hover(function () {
    $(this).css({
        "top": "-10px",
         "box-shadow": "0px 15px 30px rgba(22,10,0,0.5)",
...
// Shopping cart control display.
// $("#head_car").hover(function () {
//     $(this).css("background", "#FBFEE9");//鼠标移入#FBFEE9
//     $(".head_car_text").css("color", "#ff6700");//收藏文字的颜色变成负色
//     $("#car_content").css({"width": "300px", "border-radius": "8px"}).animate({
//         height: "100px"
//     }, 400).finish();
// }, function () {
//     $(this).css("background", "#ff6700", "color", "red");
//     $(".head_car_text").css("color", "white");
//     /*鼠标离开购物车的颜色*/
...
// Navigation bar control display.
